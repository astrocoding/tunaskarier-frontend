...
import { getCompanyById, updateCompany } from '../../apis/adminApi';
...
const CompanyUpdatePage = () => {
  ...
  useEffect(() => {
    const fetchCompany = async () => {
      try {
        ...
        setFormData({
          email: company.email || '',
          password: '', // Password field is empty for update
        ...
        Swal.fire({
          icon: 'error',
          title: 'Gagal!',
          text: error.message || 'Gagal memuat data perusahaan',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let errorMessage = 'Gagal memperbarui data perusahaan';
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                  ...
                  <h2 className="fw-bold text-primary mb-0">
                    <i className="bi bi-building me-2"></i>Edit Data Perusahaan
                  </h2>
                </div>
                ...
                <div className="col-lg-10">
                  <div className="card border-0 shadow-sm">
                    <div className="card-header bg-primary text-white">
                      <h5 className="mb-0">
                        <i className="bi bi-building me-2"></i>Form Edit Data Perusahaan
                      </h5>
                    </div>
