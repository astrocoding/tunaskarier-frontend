    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom border-end py-2">
      <div className="container-fluid">
        ...
        <a className="navbar-brand d-flex align-items-center" href="/student">
          ...
          <span className="ms-2 fw-bold text-primary">Student</span>
        </a>
        <div className="dropdown ms-auto">
          ...
          <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            <li className="dropdown-header">
              <strong>{userProfile?.full_name || 'Student'}</strong>
            </li>
            <li><hr className="dropdown-divider" /></li>
            <li><a className="dropdown-item" href="/student/profile">Profil</a></li>
            <li><hr className="dropdown-divider" /></li>
