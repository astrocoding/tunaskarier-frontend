  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom border-end py-2">
      <div className="container-fluid">
        ...
        <a className="navbar-brand d-flex align-items-center" href="/mentor">
          <img src={logo} alt="Logo TunasKarier" style={{height:'38px',width:'auto'}} />
          <span className="ms-2 fw-bold text-primary">Mentor</span>
        </a>
        <div className="dropdown ms-auto">
          ...
          <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            <li className="dropdown-header">
              <strong>{userProfile?.full_name || 'Mentor'}</strong>
            </li>
            <li><hr className="dropdown-divider" /></li>
            <li><a className="dropdown-item" href="/mentor/profile">Profil</a></li>
            <li><hr className="dropdown-divider" /></li>
